...
class PM::Package::CPAN < PM::Package
  ...
  def input(package)
    #if RUBY_VERSION =~ /^1\.8/
      #raise PM::Package::InvalidArgument,
    ...
    self.vendor = case metadata["author"]
      ...
      when Array; metadata["author"].join(", ")
        ...
        raise PM::InvalidPackageConfiguration, "Unexpected CPAN 'author' field type: #{metadata["author"].class}. This is a bug."
  ...
  def download(metadata, cpan_version=nil)
    ...
    begin
      ...
      raise PM::InvalidPackageConfiguration, "metacpan release query failed"
    end
    ...
    begin
      ...
      raise PM::InvalidPackageConfiguration, "metacpan query failed"
    end
