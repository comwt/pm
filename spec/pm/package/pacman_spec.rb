...
require 'fileutils'
require "pm" # local
require "pm/package/pacman" # local
require "stud/temporary"

describe PM::Package::Pacman do
  ...
  describe "#output" do
    let(:original) { PM::Package::Pacman.new }
    let(:input) { PM::Package::Pacman.new }
...
end # describe PM::Package::Pacman
