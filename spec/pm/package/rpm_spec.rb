require "spec_setup"
require "pm" # local
require "pm/package/rpm" # local
require "pm/package/dir" # local
  ...
  describe "#output", :if => program_exists?("rpmbuild") do
    ...
    context "package attributes" do
      ...
      it "should output a package with the correct dependencies" do
        ...
        # pm uses strings here, so convert.
      ...
      it "should have the correct 'before_install' trigger script" do
        ...
        insist { @rpm.tags[:triggerflags][0] & (1 << 25)} == ( 1 << 25) # See PM::Package::RPM#rpm_get_trigger_type
      ...
      it "should have the correct 'after_install' trigger script" do
        ...
        insist { @rpm.tags[:triggerflags][1] & (1 << 16)} == ( 1 << 16) # See PM::Package::RPM#rpm_get_trigger_type
      ...
      it "should have the correct 'before_uninstall' trigger script" do
        ...
        insist { @rpm.tags[:triggerflags][2] & (1 << 17)} == ( 1 << 17) # See PM::Package::RPM#rpm_get_trigger_type
      ...
      it "should have the correct 'after_target_uninstall' trigger script" do
        ...
        insist { @rpm.tags[:triggerflags][3] & (1 << 18)} == ( 1 << 18) # See PM::Package::RPM#rpm_get_trigger_type
      ...
      it "should use md5/gzip by default" do
        ...
        insist { [nil, PM::Package::RPM::DIGEST_ALGORITHM_MAP["md5"]] } \
    ...
    context "bzip2/sha1" do
      ...
      it "should have the compressor and digest algorithm listed" do
        ...
        insist { @rpmtags[:filedigestalgo].first } \
          == PM::Package::RPM::DIGEST_ALGORITHM_MAP["sha1"]
      end
    end # bzip2/sha1
  end # #output with digest/compression settings
end # describe PM::Package::RPM
