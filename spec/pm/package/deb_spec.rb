...
require 'fileutils'
require "pm" # local
require "pm/package/deb" # local
require "pm/package/dir" # local
require "stud/temporary"
require "English" # for $CHILD_STATUS

describe PM::Package::Deb do
  ...
  describe "#output" do
    let(:original) { PM::Package::Deb.new }
    let(:input) { PM::Package::Deb.new }
  ...
  describe "#tar_flags" do
    let(:package) { PM::Package::Deb.new }
  ...
  describe "#output with lintian" do
    ...
    before do
      ...
      subject.maintainer = "Justin Francis <jfrancis@inbox.com>"
