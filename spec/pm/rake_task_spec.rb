...
require "pm/command"
require "pm/rake_task"
require "tmpdir"

describe PM::RakeTask do
  around do |example|
  ...
  describe "#new" do
    ...
    it "executes PM::Command with the appropriate arguments" do
      command = instance_double(PM::Command)
      ...
      allow(PM::Command).to receive(:new).and_return(command)
